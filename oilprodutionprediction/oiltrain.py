...
def rm_main(data_frame1,data_frame2,):
    ...
    # 预测结果
    MODEL = load_model('D:\done\maxmin_oil\oilprodutionprediction\model_oil_.h5')
    y_predict_unit = MODEL.predict(x_test)
    # y_predict_unit = model_act.scaleD.inverse_transform(y_predict_unit.reshape(-1,1))
...
if __name__ == "__main__":
    ...
    data_test_csv = "high-test-vi.csv"
    #data_train_csv = "高含水样本2 - train.csv"
    #data_test_csv = "高含水样本2 - test.csv"
    modelpath = 'D:\done\maxmin_oil\multiwells'
