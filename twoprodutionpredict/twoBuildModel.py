...
class BuildModel():
    ...
    def __makeSample(self, sub_data, sub_jh, sub_rq):
        ...
        for i in range(0, all_count - sequence_length):
            ...
            x_data.append(x_sub)
            y_data.append(y_array[i + self.SeqLength:i + sequence_length][0])
    ...
    def FitModel(self, model, x_train, y_train, x_test, y_test):
        ...
        :return:
        '''
        save_best = ModelCheckpoint('D:/done/maxmin_oil/twoprodutionpredict/model_oil_.h5', verbose=1, save_best_only=True)
